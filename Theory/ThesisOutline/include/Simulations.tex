...
$$L_{\text{sat}}\approx \frac{T_0}{eE_{wb}} $$ 
...
\end{itemize}
\item  $$n_b=\frac{N_p}{(2\pi)^{3/2} \sigma_y^2\sigma_x}=\frac{6.25\times 10^{8}}{(2\pi)^{3/2} (5\times 10^{-6})^3}\approx 3.2\times 10^{23}~ \text{m}^{-3} ~~\Rightarrow ~~E_{\text{wb}}=54 ~\text{GeV/m}$$
