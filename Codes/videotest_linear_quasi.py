...
def video():
    ...
    for i in range (0,5):
        ...
        name2='~/higher_res_quasi_30pc/visit00%d.png'%i
        name1='~/linear_lowres_downloads/visit00%d.png'%i

        if (i<10):
            name2='~/higher_res_quasi_30pc/visit000%d.png'%i
            name1='~/linear_lowres_downloads/visit000%d.png'%i
        if (i>99):
            name2='~/higher_res_quasi_30pc/visit0%d.png'%i
            name1='~/linear_lowres_downloads/visit0%d.png'%i
        print(name1)
